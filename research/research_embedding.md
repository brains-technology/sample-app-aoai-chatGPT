...
ChatEIをはじめとするRAG製品では、事前に社内文書をembeddingによりベクトル表現として保管しておき、ユーザーからの問い合わせもベクトル化して社内文書のベクトル集団と距離計算を行うことで、類似度の高い社内文書の検索が可能となっている。そのため、どのembeddingモデルを使うかが、検索精度に大きく作用する可能性があり、今回検証を行った。
