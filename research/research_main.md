...
|:-------------------------------------------|:--------|:-------------------------------------------------|:-----------|:-------------------------------------------------------------------------------|:---------------------------------------------------------------------------|
| [チャンキングの影響](./research_chunk.md)                                  |前処理<br>(チャンク設定)| チャンク長-オーバーラップ長	512-0	512-128	1024-0　1024-256	2000-0　2000-500                           |       1,4,10      |  ストレージはチャンク長が細かくなると大きくなる。回答精度には顕著な違いは見られなかった。コストという観点では、チャンク長は長く取った方がストレージの圧迫が少ないため有利ですある。 |  一般的な傾向と合致する傾向が見られたが、そこまで顕著ではない。（長いチャンクは文脈保持に優れ、多くの事例や背景を含みやすい。一方、短いチャンクは情報の粒度が細かくなる傾向がある。オーバーラップを多く取ることで、文脈の連続性が高まり、情報の断絶を防げる。 ）                                                                    |
